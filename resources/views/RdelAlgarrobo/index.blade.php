...
@section('main-content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Grilla de Tickets SIN RESOLVER - Ruta del Algarrobo -</h3>
            <a class="btn btn-app btn" href="/Tickets/Historico/J5apvq8zq">
                <i class="fa fa-eye-slash"></i> Cerrados
            </a>
            <a class="btn btn-app btn" href="/Tickets/Full/J5apvq8zq">
