...
<head>
    ...
    <title>Ruta del Algarrobo - Tickets</title>
...
<div id="intro">
    <div class="container">
        <div class="row">
            ...
            <h3>Concesión Ruta del Algarrobo</h3>
            @if (session('status'))
...
<div class="col-lg-4">
    ...
    <h3><label for="email">info@rutadelalgarrobo.cl</label></h3>
    ...
    <a href="https://www.facebook.com/rutadelalgarrobo/">
        <img src="http://www.corporativo.bancoestado.cl/images/default-source/logos/logo-fb.png?sfvrsn=0"></a>
    <a href="http://www.twitter.com/ruta_algarrobo">
        <img src="http://www.corporativo.bancoestado.cl/images/default-source/logos/logo-tw.png?sfvrsn=0"></a>
